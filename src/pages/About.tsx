      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your trusted partner for premium electronics in Ghana. We've been serving customers 
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="mb-4">
              ...
              Darlington Store has grown from a small local shop to one of the most trusted electronics 
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Leading the vision and strategy of Darlington Store with over 10 years of experience in electronics retail.</p>
            </div>
            <div className="text-center">
              <div className="w-32 h-32 bg-gray-300 rounded-full mx-auto mb-4"></div>
